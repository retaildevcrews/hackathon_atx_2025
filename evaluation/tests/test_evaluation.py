...
class TestLLMJudge:
    ...
    @patch('evaluation.llm_judge.OpenAI')
    def test_judge_initialization(self, mock_openai):
    ...
    @patch('evaluation.llm_judge.OpenAI')
    def test_evaluate_agent_output_success(self, mock_openai):
    ...
    @patch('evaluation.llm_judge.OpenAI')
    def test_evaluate_agent_output_error_handling(self, mock_openai):
...
class TestIntegration:
    ...
    @patch('evaluation.llm_judge.OpenAI')
    def test_full_evaluation_pipeline(self, mock_openai, mock_requests):
