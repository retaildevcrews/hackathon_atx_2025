...
usage(){
  echo "Usage: $0 -g <resourceGroup> -a <apiAppName> -r <acrName> [-p <projectPath>] [-t <tag>]" >&2
}

RG=""; APP=""; ACR=""; PROJECT="../../apps/criteria_api"; TAG=""; ENVFILE=""
while [[ $# -gt 0 ]]; do
  case "$1" in
    -g|--resource-group) RG="$2"; shift 2;;
    -a|--api-app) APP="$2"; shift 2;;
    -r|--acr) ACR="$2"; shift 2;;
...
IMAGE="$LOGIN_SERVER/criteria-api:$TAG"
